...
from xorq.vendor.ibis.common.patterns import Between, InstanceOf
from xorq.vendor.ibis.common.typing import Coercible, VarTuple
from xorq.vendor.ibis.expr.operations.core import Alias, Column, Node, Scalar, Value
from xorq.vendor.ibis.expr.operations.sortkeys import SortKey
from xorq.vendor.ibis.expr.schema import Schema
from xorq.vendor.ibis.formats import TableProxy  # noqa: TCH001
...
class Filter(Simple):
    ...
    def __init__(self, parent, predicates):
        from xorq.vendor.ibis.expr.rewrites import ReductionLike, p
