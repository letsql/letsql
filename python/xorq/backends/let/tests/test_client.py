...
def test_register_table_with_uppercase(ls_con):
    ...
    assert xq.execute(t) is not None
...
@pytest.mark.parametrize(
    ...
    [
        ...
        param((xq.asc("yearID"),), id="one-column"),
        param((xq.asc("yearID"), xq.desc("stint")), id="two-columns"),
    ],
)
def test_register_record_batch_reader_sorted(batting_df, keys):
    ...
    physical_plan = xq.get_plans(expr)["physical_plan"]
