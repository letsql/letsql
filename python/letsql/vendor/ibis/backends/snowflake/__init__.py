...
from letsql.vendor.ibis.backends.snowflake.converter import SnowflakePandasData
from letsql.vendor.ibis.backends.sql import SQLBackend
from letsql.vendor.ibis.backends.sql.compilers.base import STAR
...
$$ {defn["source"]} $$"""
    ...
    def to_pyarrow(
        ...
        **kwargs: Any,
        ...
        from letsql.vendor.ibis.backends.snowflake.converter import SnowflakePyArrowData
