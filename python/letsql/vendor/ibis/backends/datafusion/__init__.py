...
from letsql.vendor.ibis.formats.pyarrow import PyArrowSchema, PyArrowType
from letsql.vendor.ibis.util import deprecated, gen_name, normalize_filename
...
class Backend(SQLBackend, CanCreateCatalog, CanCreateDatabase, CanCreateSchema, NoUrl):
    ...
    def _register_builtin_udfs(self):
        from letsql.vendor.ibis.backends.datafusion import udfs
