...
from letsql.vendor.ibis.backends import CanCreateDatabase, CanCreateSchema
from letsql.vendor.ibis.backends.bigquery.client import (
    bigquery_param,
    parse_project_and_dataset,
    rename_partitioned_column,
    schema_from_bigquery_table,
)
from letsql.vendor.ibis.backends.bigquery.datatypes import BigQuerySchema
...
class Backend(SQLBackend, CanCreateDatabase, CanCreateSchema):
    ...
    def execute(self, expr, params=None, limit="default", **kwargs):
        ...
        """
        from letsql.vendor.ibis.backends.bigquery.converter import BigQueryPandasData
