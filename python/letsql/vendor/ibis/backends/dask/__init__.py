...
from letsql.vendor.ibis.backends import NoUrl
from letsql.vendor.ibis.backends.pandas import BasePandasBackend
...
class Backend(BasePandasBackend, NoUrl):
    ...
    def _validate_args(self, expr, limit):
        if limit != "default" and limit is not None:
            raise com.UnsupportedArgumentError(
                "limit parameter to execute is not yet implemented in the dask backend"
            )
    ...
    def compile(
        ...
        **kwargs,
        ...
        from letsql.vendor.ibis.backends.dask.executor import DaskExecutor
