...
from letsql.vendor.ibis.backends.pandas.helpers import PandasUtils
    ...
    def asseries(cls, value, like=None):
        ...
        if isinstance(value, dd.Series):
            ...
            if isinstance(value, (tuple, list, dict)):
                fn = lambda df: pd.Series([value] * len(df), index=df.index)  # noqa: E731
            else:
                fn = lambda df: pd.Series(value, index=df.index)  # noqa: E731
