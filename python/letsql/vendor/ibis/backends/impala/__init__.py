...
from letsql.vendor.ibis.backends.impala import ddl, udf
from letsql.vendor.ibis.backends.impala.client import ImpalaTable
from letsql.vendor.ibis.backends.impala.ddl import (
    CTAS,
    CreateDatabase,
...
from letsql.vendor.ibis.backends.impala.udf import (
    aggregate_function,
    scalar_function,
    wrap_uda,
    wrap_udf,
...
class Backend(SQLBackend):
    ...
    def describe_formatted(
        ...
        """
        from letsql.vendor.ibis.backends.impala.metadata import parse_metadata
