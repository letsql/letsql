...
from letsql.vendor.ibis.formats.pandas import PandasData, PandasSchema
...
class BasePandasBackend(BaseBackend, NoUrl):
    ...
    class Options(letsql.vendor.ibis.config.Config):
    ...
    def _get_operations(cls):
        from letsql.vendor.ibis.backends.pandas.kernels import supported_operations
...
class Backend(BasePandasBackend):
    ...
    def execute(self, query, params=None, limit="default", **kwargs):
        from letsql.vendor.ibis.backends.pandas.executor import PandasExecutor
