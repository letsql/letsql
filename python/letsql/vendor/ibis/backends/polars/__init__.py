...
from letsql.vendor.ibis.backends import BaseBackend, NoUrl
from letsql.vendor.ibis.backends.pandas.rewrites import (
    bind_unbound_table,
    replace_parameter,
    rewrite_join,
)
from letsql.vendor.ibis.backends.polars.compiler import translate
from letsql.vendor.ibis.backends.sql.dialects import Polars
from letsql.vendor.ibis.common.dispatch import lazy_singledispatch
from letsql.vendor.ibis.expr.rewrites import lower_stringslice
from letsql.vendor.ibis.formats.polars import PolarsSchema
...
class Backend(BaseBackend, NoUrl):
    ...
    def _get_sql_string_view_schema(
        ...
        from letsql.vendor.ibis.backends.sql.compilers.postgres import compiler
