...
from letsql.vendor.ibis.backends.sql.compilers.base import TRUE, C, ColGen, F
...
class Backend(SQLBackend, CanListCatalog, CanCreateDatabase, CanCreateSchema):
    ...
    def _fetch_from_cursor(self, cursor, schema: sch.Schema) -> pd.DataFrame:
        ...
        from letsql.vendor.ibis.backends.postgres.converter import PostgresPandasData
