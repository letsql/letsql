...
from letsql.vendor.ibis.backends import CanListDatabase, CanListSchema
from letsql.vendor.ibis.backends.sql import SQLBackend
from letsql.vendor.ibis.backends.sql.compilers.base import NULL, STAR, C
...
class Backend(SQLBackend, CanListDatabase, CanListSchema):
    ...
    def _fetch_from_cursor(self, cursor, schema: sch.Schema) -> pd.DataFrame:
        ...
        from letsql.vendor.ibis.backends.oracle.converter import OraclePandasData
