...
from letsql.common.utils.inspect_utils import get_arguments
...
class BaseBackend(abc.ABC, _FileIOHandler, CacheHandler):
    ...
    def register_options(cls) -> None:
        ...
        options = letsql.vendor.ibis.config.options
