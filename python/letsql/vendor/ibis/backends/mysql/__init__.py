...
from letsql.vendor.ibis.backends import CanCreateDatabase
from letsql.vendor.ibis.backends.mysql.datatypes import _type_from_cursor_info
from letsql.vendor.ibis.backends.sql import SQLBackend
from letsql.vendor.ibis.backends.sql.compilers.base import STAR, TRUE, C
...
class Backend(SQLBackend, CanCreateDatabase):
    ...
    def _fetch_from_cursor(self, cursor, schema: sch.Schema) -> pd.DataFrame:
        ...
        from letsql.vendor.ibis.backends.mysql.converter import MySQLPandasData
