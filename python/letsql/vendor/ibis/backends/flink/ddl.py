...
from letsql.vendor.ibis.backends.sql.datatypes import FlinkType
from letsql.vendor.ibis.backends.sql.ddl import DDL, DML, CreateDDL, DropObject
from letsql.vendor.ibis.util import promote_list
...
class FlinkBase:
    ...
    def format_watermark_strategy(self, watermark: Watermark) -> str:
        from letsql.vendor.ibis.backends.flink.utils import translate_literal
