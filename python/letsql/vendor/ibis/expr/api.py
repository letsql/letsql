...
from letsql.vendor.ibis.expr.sql import parse_sql, to_sql
...
from letsql.vendor.ibis.util import experimental
...
def schema(
    ...
    Examples
    --------
    >>> from letsql.vendor.ibis import schema, Schema
...
def _memtable(
    ...
    *,
    ...
    from letsql.vendor.ibis.formats.pandas import PandasDataFrameProxy
...
def _memtable_from_polars_dataframe(
    ...
    *,
    ...
    from letsql.vendor.ibis.formats.polars import PolarsDataFrameProxy
...
def random() -> ir.FloatingScalar:
    ...
    ```python
    >>> from letsql.vendor.ibis.interactive import *
