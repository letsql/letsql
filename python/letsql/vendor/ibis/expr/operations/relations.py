...
from letsql.vendor.ibis.common.typing import Coercible, VarTuple
from letsql.vendor.ibis.expr.operations.core import Alias, Column, Node, Scalar, Value
from letsql.vendor.ibis.expr.operations.sortkeys import SortKey
from letsql.vendor.ibis.expr.schema import Schema
from letsql.vendor.ibis.formats import TableProxy  # noqa: TCH001
...
class Filter(Simple):
    ...
    def __init__(self, parent, predicates):
        from letsql.vendor.ibis.expr.rewrites import ReductionLike, p
