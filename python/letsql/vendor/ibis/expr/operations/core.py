...
from letsql.vendor.ibis.common.typing import DefaultTypeVars
from letsql.vendor.ibis.util import is_iterable
...
class Value(Node, Coercible, DefaultTypeVars, Generic[T, S]):
    ...
    def __coerce__(
        ...
        from letsql.vendor.ibis.expr.operations.generic import NULL, Literal
        from letsql.vendor.ibis.expr.types import Expr
