...
from letsql.vendor.ibis.common.deferred import Deferred, Resolver
from letsql.vendor.ibis.common.selectors import Expandable, Selector
from letsql.vendor.ibis.expr.rewrites import DerefMap
from letsql.vendor.ibis.expr.types.core import Expr, _FixedTextJupyterMixin
from letsql.vendor.ibis.expr.types.generic import Value, literal
from letsql.vendor.ibis.expr.types.temporal import TimestampColumn
...
if TYPE_CHECKING:
    ...
    from letsql.vendor.ibis.expr.operations.relations import JoinKind, Set
    from letsql.vendor.ibis.expr.schema import SchemaLike
    from letsql.vendor.ibis.expr.types import Table
    from letsql.vendor.ibis.expr.types.groupby import GroupedTable
    from letsql.vendor.ibis.expr.types.temporal_windows import WindowedTable
    from letsql.vendor.ibis.formats.pandas import PandasData
    from letsql.vendor.ibis.formats.pyarrow import PyArrowData
    from letsql.vendor.ibis.selectors import IfAnyAll
...
class Table(Expr, _FixedTextJupyterMixin):
    ...
    def __dataframe__(self, nan_as_null: bool = False, allow_copy: bool = True):
        from letsql.vendor.ibis.expr.types.dataframe_interchange import IbisDataFrame
    ...
    def __pyarrow_result__(
        ...
        *,
        ...
        if data_mapper is None:
            from letsql.vendor.ibis.formats.pyarrow import PyArrowData as data_mapper
    ...
    def __pandas_result__(
        ...
        *,
        ...
        if data_mapper is None:
            from letsql.vendor.ibis.formats.pandas import PandasData as data_mapper
    ...
    def __polars_result__(self, df: pl.DataFrame) -> Any:
        from letsql.vendor.ibis.formats.polars import PolarsData
    ...
    def __getitem__(self, what: str | int | slice | Sequence[str | int]):
        ...
        └─────────┴───────────┴────────────────┴───────────────┴───────────────────┴───┘
        """
        from letsql.vendor.ibis.expr.types.logical import BooleanValue
    ...
    def aggregate(
        ...
        **kwargs: ir.Value,
        ...
        └────────┴────────────┴──────────┘
        """
        from letsql.vendor.ibis.common.patterns import Contains, In
        from letsql.vendor.ibis.expr.rewrites import p
    ...
    def select(
        ...
        **named_exprs: ir.Value | str,
        ...
        └────────────────┴───────────────┴───────────────────┴─────────────┘
        """
        from letsql.vendor.ibis.expr.rewrites import rewrite_project_input
    ...
    def filter(
        ...
        *predicates: ir.BooleanValue | Sequence[ir.BooleanValue] | IfAnyAll,
        ...
        └────────┴───────────┘
        """
        from letsql.vendor.ibis.expr.rewrites import (
            flatten_predicates,
    ...
    def info(self) -> Table:
        ...
        └───────────────────┴─────────┴──────────┴───────┴───────────┴───────────┴───┘
        """
        from letsql.vendor.ibis import literal as lit
    ...
    def join(
        ...
        *,
        ...
        └─────────┴───────────────────┴───────────────┴───────────────────┘
        """
        from letsql.vendor.ibis.expr.types.joins import Join
    ...
    def pivot_wider(
        ...
        *,
        ...
        """
        import letsql.vendor.ibis.selectors as s
        from letsql.vendor.ibis.expr.rewrites import _, p, x
    ...
    def value_counts(self) -> ir.Table:
        ...
        Examples
        --------
        >>> from letsql.vendor.ibis import examples
        >>> ibis.options.interactive = True
