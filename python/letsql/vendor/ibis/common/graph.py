...
from letsql.vendor.ibis.common.bases import Hashable
from letsql.vendor.ibis.common.patterns import NoMatch, Pattern
from letsql.vendor.ibis.common.typing import _ClassInfo
from letsql.vendor.ibis.util import experimental, promote_list
...
def _flatten_collections(node: Any) -> Iterator[N]:
    ...
    >>> from letsql.vendor.ibis.common.graph import Node
    >>>
