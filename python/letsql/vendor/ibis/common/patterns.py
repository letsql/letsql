...
from letsql.vendor.ibis.common.bases import FrozenSlotted as Slotted
from letsql.vendor.ibis.common.bases import Hashable, Singleton
from letsql.vendor.ibis.common.collections import (
    FrozenDict,
    RewindableIterator,
    frozendict,
)
from letsql.vendor.ibis.common.deferred import (
    Deferred,
    Factory,
    Resolver,
    Variable,
...
from letsql.vendor.ibis.common.typing import (
    Coercible,
    CoercionError,
    Sentinel,
    UnionType,
...
from letsql.vendor.ibis.util import import_object, is_iterable, unalias_package
...
class CallableWith(Slotted, Pattern):
    ...
    def match(self, value, context):
        from letsql.vendor.ibis.common.annotations import EMPTY, annotated
