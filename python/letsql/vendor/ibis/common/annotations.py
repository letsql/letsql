...
from letsql.vendor.ibis.common.bases import Immutable, Slotted
from letsql.vendor.ibis.common.patterns import (
    Any,
    FrozenDictOf,
    NoMatch,
    Option,
...
from letsql.vendor.ibis.common.patterns import pattern as ensure_pattern
from letsql.vendor.ibis.common.typing import format_typehint, get_type_hints
...
def annotated(_1=None, _2=None, _3=None, **kwargs):
    ...
    >>> from letsql.vendor.ibis.common.patterns import InstanceOf as instance_of
